export const gyro2CLPAbi_V3 = [
        ...
        inputs: [
            {
                ...
                internalType: 'struct IGyro2CLPPool.GyroParams',
                name: 'params',
                type: 'tuple',
            },
            {
    ...
    {
        inputs: [],
        name: 'getGyro2CLPPoolDynamicData',
        outputs: [
            {
                components: [
                    {
                ...
                internalType: 'struct Gyro2CLPPoolDynamicData',
                name: 'data',
                type: 'tuple',
            },
        ],
    ...
    {
        inputs: [],
        name: 'getGyro2CLPPoolImmutableData',
        outputs: [
            {
                components: [
                    {
                ...
                internalType: 'struct Gyro2CLPPoolImmutableData',
                name: 'data',
                type: 'tuple',
            },
        ],
