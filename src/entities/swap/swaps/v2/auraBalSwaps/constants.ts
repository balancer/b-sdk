...
export const supportedTokens = [BAL, NATIVE_ASSETS[1].wrapped];
export const auraBalToken = new Token(1, auraBAL, 18);
...
export const balWethAssets = [BAL, NATIVE_ASSETS[1].wrapped] as Address[];
