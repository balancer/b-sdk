...
class LogExpMath {
    ...
    static exp(x_: bigint): bigint {
        ...
        // decomposition.
        // At the end of LogExpMath process we will have the product of all e^x_n = a_n that apply, and the remainder of LogExpMath
    ...
    static _ln(a_: bigint): bigint {
        ...
        if (a < WAD) {
            ...
            // than one, 1/a will be greater than one, and LogExpMath if statement will not be entered in the recursive call.
            // Fixed point division requires multiplying by LogExpMath.ONE_18.
        ...
        // At the end of LogExpMath process we will have the sum of all x_n = ln(a_n) that apply, and the remainder of LogExpMath
        ...
        // LogExpMath.ONE_18 to convert them to fixed point.
        ...
        // All other a_n and x_n are stored as 20 digit fixed point numbers, so we convert the sum and a to LogExpMath format.
        sum *= 100n;
        a *= 100n;
