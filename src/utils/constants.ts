...
export const VAULT_V3: Record<number, Address> = {
    [ChainId.SEPOLIA]: '0xBC582d2628FcD404254a1e12CB714967Ce428915', // TODO: Sepolia to deploy12 -> 0xbA1333333333a1BA1108E8412f11850A5C319bA9
...
export const VAULT_ADMIN: Record<number, Address> = {
    [ChainId.SEPOLIA]: '0x2AD9162D9b388b75eB40cBF996AbE8E968670c5C', // TODO: Sepolia to deploy12 -> 0x35fFB749B273bEb20F40f35EdeB805012C539864
...
export const WEIGHTED_POOL_FACTORY_BALANCER_V3: Record<number, Address> = {
    [ChainId.SEPOLIA]: '0x9aAD2c188b4eACcA85C44E7A9250dDADcae1A2E9', // TODO: Sepolia to deploy12 -> 0x7532d5a3bE916e4a4D900240F49F0BABd4FD855C
...
export const STABLE_POOL_FACTORY_BALANCER_V3: Record<number, Address> = {
    [ChainId.SEPOLIA]: '0xcB107E7075add7a95ae7192c052b4e6814bf0ad5', // TODO: Sepolia to deploy12 -> 0xd67F485C07D258B3e93835a3799d862ffcB55923
...
export const BALANCER_ROUTER: Record<number, Address> = {
    [ChainId.SEPOLIA]: '0x4D2aA7a3CD7F8dA6feF37578A1881cD63Fd3715E', // TODO: Sepolia to deploy12 -> 0x0BF61f706105EA44694f2e92986bD01C39930280
...
export const BALANCER_BATCH_ROUTER: Record<number, Address> = {
    [ChainId.SEPOLIA]: '0x4232e5EEaA16Bcf483d93BEA469296B4EeF22503', // TODO: Sepolia to deploy12 -> 0xC85b652685567C1B074e8c0D4389f83a2E458b1C
...
export const BALANCER_COMPOSITE_LIQUIDITY_ROUTER: Record<number, Address> = {
    [ChainId.SEPOLIA]: '0x2F118d8397D861354751709e1E0c14663e17F5C1', // TODO: Sepolia to deploy12 -> 0xc6674C0c7694E9b990eAc939E74F8cc3DD39B4b0
...
export const BALANCER_BUFFER_ROUTER: Record<number, Address> = {
    [ChainId.SEPOLIA]: '0xD907aFAF02492e054D64da3A14312BdA356fc618', // TODO: Sepolia to deploy12 -> 0xb5F3A41515457CC6E2716c62a011D260441CcfC9
