...
export type Scalars = {
  ...
  GqlBigNumber: { input: unknown; output: unknown; }
...
export type poolGetPoolWithUnderlyingsQuery = { __typename?: 'Query', poolGetPool:
    ...
    | { __typename?: 'GqlPoolFixedPriceLBP', id: string, address: string, type: GqlPoolType, protocolVersion: number, poolTokens: Array<{ __typename?: 'GqlPoolTokenDetail', index: number, address: string, decimals: number, underlyingToken?: { __typename?: 'GqlToken', address: string, decimals: number } | null }> }
...
export type poolGetNestedPoolQuery = { __typename?: 'Query', poolGetPool:
    ...
    | { __typename?: 'GqlPoolFixedPriceLBP', id: string, protocolVersion: number, address: string, type: GqlPoolType, poolTokens: Array<{ __typename?: 'GqlPoolTokenDetail', index: number, address: string, decimals: number, nestedPool?: { __typename?: 'GqlNestedPool', id: string, address: string, type: GqlPoolType, tokens: Array<{ __typename?: 'GqlPoolTokenDetail', index: number, address: string, decimals: number, underlyingToken?: { __typename?: 'GqlToken', address: string, decimals: number } | null }> } | null, underlyingToken?: { __typename?: 'GqlToken', address: string, decimals: number } | null }> }
...
export type poolGetPoolQuery = { __typename?: 'Query', poolGetPool:
    ...
    | { __typename?: 'GqlPoolFixedPriceLBP', id: string, address: string, type: GqlPoolType, protocolVersion: number, poolTokens: Array<{ __typename?: 'GqlPoolTokenDetail', index: number, address: string, decimals: number }> }
...
export type poolGetPoolWithBalancesQuery = { __typename?: 'Query', poolGetPool:
    ...
    | { __typename?: 'GqlPoolFixedPriceLBP', id: string, address: string, type: GqlPoolType, protocolVersion: number, poolTokens: Array<{ __typename?: 'GqlPoolTokenDetail', index: number, address: string, decimals: number, balance: string }>, dynamicData: { __typename?: 'GqlPoolDynamicData', totalShares: string } }
