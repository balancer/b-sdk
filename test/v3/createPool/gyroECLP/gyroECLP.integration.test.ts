...
describe('GyroECLP - create & init', () => {
    ...
    beforeAll(async () => {
        ...
        // );
        const eclpParams = {
            alpha: parseUnits('450', 18),
            beta: parseUnits('650', 18),
            c: parseUnits('0.001785711438600104', 18),
            s: parseUnits('0.999998405616057996', 18),
            lambda: parseUnits('1', 18),
        };
        ...
        poolInput = {
            ...
            tokens: [
                {
                    address: '0xb4444468e444f89e1c2cac2f1d3ee7e336cbd1f5', // RZR
                    rateProvider: zeroAddress,
                    tokenType: TokenType.STANDARD,
                    paysYieldFees: false,
                },
                {
                    address: '0x6f330fee89ad64cae005f85764e7f7dd3f660b2b', // FARM
                    rateProvider: zeroAddress,
                    tokenType: TokenType.STANDARD,
                    paysYieldFees: false,
                },
        ...
        console.log('Sonic balance:', formatEther(nativeBalance));
