...
export const POOLS: Record<number, Record<string, TestPool>> = {
    ...
    [ChainId.SEPOLIA]: {
        MOCK_WETH_BAL_POOL: {
            address: '0xd71958aeD5E2e835A648Ff832a181F7BdaBbaF13',
        ...
        MOCK_BAL_DAI_POOL: {
            address: '0xaf4A2f78955B0230900B55ffC763C0c31Ca266a1',
            id: '0xaf4A2f78955B0230900B55ffC763C0c31Ca266a1',
            type: PoolType.Weighted,
            decimals: 18,
            slot: 0,
        },
        MOCK_USDC_DAI_POOL: {
            address: '0x614AcF94c16eD10E71c5873d72341be06ecC5036',
            id: '0x614AcF94c16eD10E71c5873d72341be06ecC5036',
            type: PoolType.Weighted,
            decimals: 18,
            slot: 0,
        },
        MOCK_NESTED_POOL: {
            address: '0xc0b130d48Ff117f504DD10af791670AD127813D5',
            id: '0xc0b130d48Ff117f504DD10af791670AD127813D5',
            type: PoolType.Weighted,
            decimals: 18,
            slot: 0,
        },
        ...
        MOCK_BOOSTED_POOL: {
            address: '0x797C69B235Cb047c9331D39C96f30F76DCE6444d',
            id: '0x797C69B235Cb047c9331D39C96f30F76DCE6444d',
            type: PoolType.Stable,
            decimals: 18,
            slot: 0,
        },
