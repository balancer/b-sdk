...
const lbpParams: LBPParams = {
    owner: '0x43e6055bF65cF0ec86497DD88D7d4C41Acb36D55',
    ...
    startTime: BigInt(Math.floor(Date.now() / 1000)) + BigInt(60 * 60), // start in 1 hour
    endTime: BigInt(Math.floor(Date.now() / 1000)) + BigInt(60 * 60 * 96), // end in 96 hours
